...
public partial class GameBootstrap
{
    ...
    {
        return TryGetRotatedBuildingPlacement(anchorCell, LocationType.PrimarySchool, 4, 3, out min, out max);
    }

    private bool TryGetSecondarySchoolPlacement(Vector2Int anchorCell, out Vector2Int min, out Vector2Int max)
    {
        return TryGetRotatedBuildingPlacement(anchorCell, LocationType.SecondarySchool, 5, 3, out min, out max);
    }

    private bool GetPrimarySchoolPlacementPreview(Vector2Int anchorCell, out Vector3 previewPosition, out Vector3 previewScale)
    {
        return GetRotatedBuildingPlacementPreview(anchorCell, LocationType.PrimarySchool, 4, 3, out previewPosition, out previewScale);
    }
    ...
    {
        return GetRotatedBuildingPlacementPreview(anchorCell, LocationType.SecondarySchool, 5, 3, out previewPosition, out previewScale);
    }

    private void CreateSchoolDecoration(LocationType schoolType, Transform parent, Vector3 center, Vector2Int min, Vector2Int max, Vector2Int anchor)
    {
        ...
        float width = secondary ? 4.48f : 3.42f;
        ...
        int windowCount = secondary ? 4 : 3;
        CreateBuildingWindowRow(root, new Vector3(-1.42f, secondary ? 0.72f : 0.54f, 0.78f), new Vector3(0.70f, 0f, 0f), windowCount, new Vector3(0.34f, 0.24f, 0.04f), glass);
        if (secondary)
        {
            CreateBuildingWindowRow(root, new Vector3(-1.42f, 1.02f, 0.78f), new Vector3(0.70f, 0f, 0f), windowCount, new Vector3(0.32f, 0.20f, 0.04f), glass);
        }

        CreateBuildingBox(root, "SchoolYard", new Vector3(0f, -0.19f, 1.14f), new Vector3(secondary ? 3.92f : 3.00f, 0.025f, 1.18f), asphalt, VisualSmoothnessAsphalt, true);
        ...
        if (secondary)
        {
            CreateBuildingBox(root, "SchoolBasketCourt", new Vector3(-1.08f, -0.145f, 1.20f), new Vector3(1.22f, 0.02f, 0.72f), new Color(0.44f, 0.48f, 0.50f), VisualSmoothnessAsphalt, true);
            CreateBuildingBox(root, "SchoolCourtLine", new Vector3(-1.08f, -0.125f, 1.20f), new Vector3(1.10f, 0.012f, 0.04f), trim, VisualSmoothnessDefault, true);
            CreateBuildingCylinder(root, "SchoolFlagPole", new Vector3(1.60f, 0.36f, 0.92f), new Vector3(0.035f, 0.72f, 0.035f), new Color(0.82f, 0.84f, 0.82f), VisualSmoothnessVehicleMetal, true);
            CreateBuildingBox(root, "SchoolFlag", new Vector3(1.78f, 0.72f, 0.92f), new Vector3(0.34f, 0.20f, 0.03f), trim, VisualSmoothnessDefault, true);
        }
        else
        {
            CreateBuildingBox(root, "SchoolBench", new Vector3(-1.04f, 0.02f, 1.18f), new Vector3(0.70f, 0.10f, 0.18f), new Color(0.50f, 0.32f, 0.20f), VisualSmoothnessWood, true);
            CreateBuildingCylinder(root, "SchoolBell", new Vector3(1.18f, 0.78f, 0.82f), new Vector3(0.16f, 0.12f, 0.16f), trim, VisualSmoothnessVehicleMetal, true);
            CreateBuildingBox(root, "SchoolPlanter", new Vector3(1.08f, -0.05f, 1.24f), new Vector3(0.66f, 0.14f, 0.34f), new Color(0.42f, 0.30f, 0.18f), VisualSmoothnessWood, true);
            CreateBuildingCylinder(root, "SchoolPlanterLeaf", new Vector3(1.02f, 0.08f, 1.22f), new Vector3(0.18f, 0.08f, 0.18f), new Color(0.30f, 0.52f, 0.26f), VisualSmoothnessDefault, true);
            CreateBuildingCylinder(root, "SchoolPlanterLeaf", new Vector3(1.22f, 0.09f, 1.26f), new Vector3(0.16f, 0.08f, 0.16f), new Color(0.36f, 0.58f, 0.28f), VisualSmoothnessDefault, true);
        }
    }
}
