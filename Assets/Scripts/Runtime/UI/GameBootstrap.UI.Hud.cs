...
public partial class GameBootstrap
{
    ...
    private string GetBuildingResourceLabel(LocationType locationType)
    {
        ...
        return locationType switch
        {
            ...
            LocationType.Bar => "Service fee: $8",
            LocationType.Canteen => "Service fee: $8",
            LocationType.Kiosk => "Snack / Coffee: $4",
            LocationType.Kindergarten => $"Child care: {FormatKindergartenCoverageLabel(false)}",
            LocationType.PrimarySchool => $"Primary school: {FormatEducationCoverageLabel(LocationType.PrimarySchool, false)}",
            LocationType.SecondarySchool => $"Secondary school: {FormatEducationCoverageLabel(LocationType.SecondarySchool, false)}",
            LocationType.LaborExchange => $"Vacancies: {CountAvailableLaborExchangePostings()}",
            LocationType.CleaningDepot => $"Street litter: {CountVisibleStreetLitterCells()}",
    ...
    private static string GetSelectedLocationDisplayName(LocationType locationType)
    {
        return locationType switch
        {
            ...
            LocationType.PrimarySchool => IsRussianLanguage() ? "\u041d\u0430\u0447\u0430\u043b\u044c\u043d\u0430\u044f \u0448\u043a\u043e\u043b\u0430" : "Primary School",
            LocationType.SecondarySchool => IsRussianLanguage() ? "\u0421\u0440\u0435\u0434\u043d\u044f\u044f \u0448\u043a\u043e\u043b\u0430" : "Secondary School",
            ...
            LocationType.CleaningDepot => IsRussianLanguage() ? "\u0421\u043b\u0443\u0436\u0431\u0430 \u0443\u0431\u043e\u0440\u043a\u0438" : "Cleaning Depot",
