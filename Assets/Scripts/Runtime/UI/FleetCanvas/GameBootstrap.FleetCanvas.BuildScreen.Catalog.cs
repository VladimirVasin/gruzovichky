    ...
    private string GetBuildDescription(BuildTool tool, bool isActive)
    {
        ...
        if (isActive)
        {
            return tool switch
            {
                ...
                BuildTool.Kiosk            => ru ? $"Режим активен: поставь киоск 2x1 без подъезда к дороге. R — поворот ({rot})." : $"Mode active: place a 2x1 walk-up kiosk. No road driveway required. R rotates ({rot}).",
                BuildTool.CoffeeShop       => ru ? $"Режим активен: поставь кофейню 2x2 без подъезда к дороге. R — поворот ({rot})." : $"Mode active: place a 2x2 walk-up coffee shop. No road driveway required. R rotates ({rot}).",
        ...
        return tool switch
        {
            ...
            BuildTool.Canteen          => ru ? "Столовая: водители и рабочие платят $10 за обед. Можно строить несколько." : "Service building: visiting drivers/workers pay $10 for a quick meal. Multiple canteens are allowed.",
            BuildTool.Kiosk            => ru ? "Киоск: рабочие подходят к стойке и покупают Snack за $5. Подъезд к дороге не нужен." : "Walk-up kiosk: workers buy a $5 Snack for their inventory. No road driveway required.",
            BuildTool.CoffeeShop       => ru ? "Кофейня: рабочие подходят к стойке и покупают Coffee за $5. Подъезд к дороге не нужен." : "Walk-up coffee shop: workers buy a $5 Coffee for their inventory. No road driveway required.",
            ...
            BuildTool.CityHall         => locations.ContainsKey(LocationType.CityHall) ? alreadyBuilt : (ru ? "\u0420\u0430\u0442\u0443\u0448\u0430 4x3: \u0433\u043e\u0440\u043e\u0436\u0430\u043d\u0435 \u043f\u043e\u0434\u0430\u044e\u0442 \u0436\u0430\u043b\u043e\u0431\u044b, \u0430 \u0438\u0433\u0440\u043e\u043a \u0432\u0438\u0434\u0438\u0442 \u0438\u0445 \u043a\u0430\u043a \u0433\u043e\u0440\u043e\u0434\u0441\u043a\u0438\u0435 \u0437\u0430\u0434\u0430\u0447\u0438." : "4x3 city hall: citizens file complaints here and the player reviews them as city tasks."),
