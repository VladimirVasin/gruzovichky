...
public partial class GameBootstrap
{
    ...
    private WorkerThoughtDisplayData GetWorkerThoughtDisplayData(WorkerThought thought)
    {
        ...
        return key switch
        {
            ...
            "street_litter_low" => new WorkerThoughtDisplayData("\u041c\u0443\u0441\u043e\u0440 \u043d\u0430 \u0443\u043b\u0438\u0446\u0435", RenderWorkerThought(thought, true), GetWorkerThoughtCityIcon(), neutral),
            "street_litter_medium" => new WorkerThoughtDisplayData("\u0423\u043b\u0438\u0446\u044b \u0437\u0430\u043c\u0443\u0441\u043e\u0440\u0435\u043d\u044b", RenderWorkerThought(thought, true), GetWorkerThoughtCityIcon(), warning),
            "street_litter_high" => new WorkerThoughtDisplayData("\u041c\u0443\u0441\u043e\u0440 \u0440\u0430\u0437\u0434\u0440\u0430\u0436\u0430\u0435\u0442", RenderWorkerThought(thought, true), GetWorkerInventoryWarningIcon(), warning),
            ...
            "social_learned_new_topic" => new WorkerThoughtDisplayData("\u042f \u0443\u0437\u043d\u0430\u043b \u0447\u0442\u043e-\u0442\u043e \u043d\u043e\u0432\u043e\u0435", RenderWorkerThought(thought, true), GetWorkerThoughtSpeechIcon(), thought.Tone == WorkerThoughtTone.Positive ? positive : thought.Tone == WorkerThoughtTone.Negative ? warning : neutral),
            ...
            "affect_financial_pressure" => new WorkerThoughtDisplayData("\u0424\u0438\u043d\u0430\u043d\u0441\u043e\u0432\u043e\u0435 \u043d\u0430\u043f\u0440\u044f\u0436\u0435\u043d\u0438\u0435", RenderWorkerThought(thought, true), GetWorkerThoughtCoinsIcon(), warning),
            "affect_family_anxiety" => new WorkerThoughtDisplayData("\u0421\u0435\u043c\u0435\u0439\u043d\u0430\u044f \u0442\u0440\u0435\u0432\u043e\u0433\u0430", RenderWorkerThought(thought, true), GetWorkerThoughtPeopleIcon(), warning),
            "affect_relief_after_rest" => new WorkerThoughtDisplayData("\u041e\u0431\u043b\u0435\u0433\u0447\u0435\u043d\u0438\u0435", RenderWorkerThought(thought, true), GetNeedsLeisureIcon(), positive),
            "affect_hangover" => new WorkerThoughtDisplayData("\u0422\u044f\u0436\u0435\u0441\u0442\u044c \u043f\u043e\u0441\u043b\u0435 \u043e\u0442\u0434\u044b\u0445\u0430", RenderWorkerThought(thought, true), GetNeedsSleepIcon(), warning),
            "affect_litter_irritation" => new WorkerThoughtDisplayData("\u0420\u0430\u0437\u0434\u0440\u0430\u0436\u0435\u043d \u043c\u0443\u0441\u043e\u0440\u043e\u043c", RenderWorkerThought(thought, true), GetWorkerInventoryWarningIcon(), warning),
            "affect_gambling_excitement" => new WorkerThoughtDisplayData("\u0410\u0437\u0430\u0440\u0442", RenderWorkerThought(thought, true), GetWorkerThoughtCoinsIcon(), positive),
            "affect_gambling_regret" => new WorkerThoughtDisplayData("\u0421\u043e\u0436\u0430\u043b\u0435\u043d\u0438\u0435 \u043f\u043e\u0441\u043b\u0435 \u0441\u0442\u0430\u0432\u043a\u0438", RenderWorkerThought(thought, true), GetWorkerThoughtCoinsIcon(), warning),
            "affect_stable_routine" => new WorkerThoughtDisplayData("\u0421\u0442\u0430\u0431\u0438\u043b\u044c\u043d\u044b\u0439 \u0440\u0438\u0442\u043c", RenderWorkerThought(thought, true), GetWorkerThoughtSpeechIcon(), positive),
