...
public partial class GameBootstrap
{
    ...
    private void RebuildStatesScreenContent()
    {
        ...
        {
            AddStatesReferenceRow(font, GetWorkerTraitDisplayName(WorkerTraitPool[i], ru), GetWorkerTraitDescription(WorkerTraitPool[i], ru), GetWorkerTraitColor(WorkerTraitPool[i]));
        }

        AddStatesSectionHeader(font, ru ? "Слабости" : "Weaknesses");
        AddStatesReferenceRow(font, GetWorkerWeaknessDisplayName(WorkerWeaknessKind.None, ru), GetWorkerWeaknessDescription(WorkerWeaknessKind.None, ru), GetWorkerWeaknessColor(WorkerWeaknessKind.None));
        for (int i = 0; i < WorkerWeaknessPool.Length; i++)
        {
            WorkerWeaknessKind weakness = WorkerWeaknessPool[i];
            AddStatesReferenceRow(font, GetWorkerWeaknessDisplayName(weakness, ru), GetWorkerWeaknessDescription(weakness, ru), GetWorkerWeaknessColor(weakness));
        }

        AddStatesSectionHeader(font, ru ? "\u0412\u0440\u0435\u043c\u0435\u043d\u043d\u044b\u0435 affect-\u0441\u043e\u0441\u0442\u043e\u044f\u043d\u0438\u044f" : "Temporary affect states");
        for (int i = 0; i < WorkerAffectCatalog.Length; i++)
        {
            WorkerAffectKind affect = WorkerAffectCatalog[i];
            AddStatesReferenceRow(font, GetWorkerAffectDisplayName(affect, ru), GetWorkerAffectReferenceDescription(affect, ru), GetWorkerAffectColor(affect));
        }
        ...
        AddStatesReferenceRow(font, ru ? "\u0414\u043e\u0441\u0443\u0433" : "Leisure", ru ? "Парк, Бар и Игровые закрывают досуг. Слабости могут сдвигать выбор, но не гарантируют его." : "Park, Bar, and Gambling Hall satisfy leisure. Weaknesses can shift the choice, but do not guarantee it.", FleetSecondaryTextColor);
        ...
        AddStatesSectionHeader(font, ru ? "\u041c\u044b\u0441\u043b\u0438: \u0441\u043b\u0443\u0436\u0435\u0431\u043d\u044b\u0435 \u043f\u043e\u043c\u0435\u0442\u043a\u0438" : "Thoughts: implementation notes");
        AddStatesReferenceRow(font, "need_*_warning", ru ? "\u0428\u0430\u0431\u043b\u043e\u043d\u044b \u0438 UI-case \u0435\u0441\u0442\u044c, \u043d\u043e \u0442\u0435\u043a\u0443\u0449\u0430\u044f active-\u043b\u043e\u0433\u0438\u043a\u0430 \u0440\u043e\u0436\u0434\u0430\u0435\u0442 \u0442\u043e\u043b\u044c\u043a\u043e critical-\u043c\u044b\u0441\u043b\u0438. Warning \u0441\u0435\u0439\u0447\u0430\u0441 \u0441\u043f\u0440\u0430\u0432\u043e\u0447\u043d\u044b\u0439/\u0431\u0443\u0434\u0443\u0449\u0438\u0439 \u0441\u043b\u043e\u0439." : "Template and UI cases exist, but current active rules emit only critical need thoughts. Warning is reference/future-layer only for now.", FleetMutedTextColor);
        AddStatesReferenceRow(font, "no_job_today", ru ? "Legacy alias. \u041d\u043e\u0432\u0430\u044f \u0430\u043a\u0442\u0438\u0432\u043d\u0430\u044f \u043b\u043e\u0433\u0438\u043a\u0430 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u0443\u0435\u0442 no_job_warning; \u0441\u0442\u0430\u0440\u044b\u0439 \u043a\u043b\u044e\u0447 \u043e\u0441\u0442\u0430\u0432\u043b\u0435\u043d \u0434\u043b\u044f \u0441\u0442\u0430\u0440\u044b\u0445 \u043c\u044b\u0441\u043b\u0435\u0439/\u0441\u043e\u0432\u043c\u0435\u0441\u0442\u0438\u043c\u043e\u0441\u0442\u0438." : "Legacy alias. The active logic now uses no_job_warning; the old key remains for old thoughts/compatibility.", FleetMutedTextColor);
        AddStatesReferenceRow(font, "street_litter_low/medium/high", ru ? "\u0410\u043a\u0442\u0438\u0432\u043d\u044b\u0435 \u043c\u044b\u0441\u043b\u0438 \u043e \u043c\u0443\u0441\u043e\u0440\u0435. \u0412 Workers UI \u0443 \u043d\u0438\u0445 \u0435\u0441\u0442\u044c \u043e\u0442\u0434\u0435\u043b\u044c\u043d\u043e\u0435 \u0447\u0438\u0442\u0430\u0435\u043c\u043e\u0435 \u043e\u0442\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435." : "Active litter thoughts. Workers UI now gives them dedicated readable display cases.", FleetAccentColor);
