...
public partial class GameBootstrap
{
    ...
    private void RebuildStatesScreenContent()
    {
        ...
        statesScreenUi.SubtitleText.text = ru
            ? "\u0427\u0435\u0440\u0442\u044b, \u0434\u043e\u0441\u0443\u0433 \u0438 affect-\u0441\u043e\u0441\u0442\u043e\u044f\u043d\u0438\u044f \u0432\u043b\u0438\u044f\u044e\u0442 \u043d\u0430 \u043c\u044b\u0441\u043b\u0438, \u0437\u043d\u0430\u043d\u0438\u044f \u0438 \u043d\u043e\u043e\u0441\u0444\u0435\u0440\u0443, \u043d\u043e \u043d\u0435 \u0434\u0430\u044e\u0442 \u0441\u043a\u0440\u044b\u0442\u044b\u0445 \u0431\u043e\u043d\u0443\u0441\u043e\u0432 \u043a \u0440\u0430\u0431\u043e\u0442\u0435."
            : "Traits, leisure, and affect states feed thoughts, knowledge, and the Noosphere without hidden work bonuses.";

        ClearUiChildren(statesScreenUi.ContentRoot);
        AddStatesSectionHeader(font, ru ? "\u0427\u0435\u0440\u0442\u044b" : "Traits");
        for (int i = 0; i < WorkerTraitPool.Length; i++)
        {
            AddStatesReferenceRow(font, GetWorkerPerkDisplayName(WorkerTraitPool[i], ru), GetWorkerPerkDescription(WorkerTraitPool[i], ru), GetWorkerPerkColor());
        }

        AddStatesSectionHeader(font, ru ? "\u041f\u0440\u0435\u0434\u043f\u043e\u0447\u0442\u0435\u043d\u0438\u0435 \u0434\u043e\u0441\u0443\u0433\u0430" : "Leisure preference");
        for (int i = 0; i < WorkerLeisurePreferencePool.Length; i++)
        {
            WorkerLeisurePreferenceKind preference = WorkerLeisurePreferencePool[i];
            AddStatesReferenceRow(font, GetWorkerLeisurePreferenceDisplayName(preference, ru), GetWorkerLeisurePreferenceDescription(preference, ru), GetWorkerLeisurePreferenceColor(preference));
        }
        ...
        AddStatesReferenceRow(font, ru ? "\u0421\u043c\u044b\u0448\u043b\u0451\u043d\u044b\u0439" : "Quick Learner", ru ? "\u041a\u0430\u043a legacy-\u0447\u0435\u0440\u0442\u0430 \u0432\u0441\u0451 \u0435\u0449\u0451 \u0443\u0441\u043a\u043e\u0440\u044f\u0435\u0442 \u043f\u0440\u043e\u0444\u0443\u0440\u043e\u0432\u043d\u0438: \u0443\u0440. 2 \u043f\u043e\u0441\u043b\u0435 2 \u0440\u0430\u0431. \u0434\u043d\u0435\u0439, \u0443\u0440. 3 \u043f\u043e\u0441\u043b\u0435 7." : "As legacy behavior, this trait still accelerates professional levels: level 2 after 2 workdays, level 3 after 7.", GetWorkerPerkColor());
        ...
        AddStatesReferenceRow(font, ru ? "\u0414\u043e\u0441\u0443\u0433" : "Leisure", ru ? "\u041f\u0430\u0440\u043a, \u0411\u0430\u0440 \u0438 \u0418\u0433\u0440\u043e\u0432\u044b\u0435 \u0437\u0430\u043a\u0440\u044b\u0432\u0430\u044e\u0442 \u0434\u043e\u0441\u0443\u0433. \u041e\u0441\u043d\u043e\u0432\u043d\u043e\u0435 \u043f\u0440\u0435\u0434\u043f\u043e\u0447\u0442\u0435\u043d\u0438\u0435 \u0441\u0434\u0432\u0438\u0433\u0430\u0435\u0442 \u0432\u044b\u0431\u043e\u0440." : "Park, Bar, and Gambling Hall satisfy leisure. Primary preference shifts the choice.", FleetSecondaryTextColor);
