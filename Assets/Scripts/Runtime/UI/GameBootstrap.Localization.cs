...
public partial class GameBootstrap
{
    ...
    private static readonly Dictionary<string, string> RussianUi = new()
    {
        ...
        { "This is User mode. The town starts with missing buildings, roads, and workers.\n\nYour goal is simple: build the missing pieces, connect them with roads, hire workers, assign jobs, and move resources with trucks.\n\nStart by building a Motel.", "Это пользовательский режим. Город стартует без части зданий, дорог и рабочих.\n\nТвоя цель простая: построить недостающее, соединить здания дорогами, нанять рабочих, назначить им работу и перевозить ресурсы грузовиками.\n\nНачни со строительства Мотеля." },
        { "The Motel unlocks worker hiring and gives workers a place to rest.\n\nOpen Building at the top, or press B. Choose Motel and place it near your road plan.\n\nIn Build mode, press R to rotate the building before placing it.", "Мотель открывает найм рабочих и даёт им место для отдыха.\n\nОткрой Стройку сверху или нажми B. Выбери Мотель и поставь его рядом с будущими дорогами.\n\nВ режиме строительства нажимай R, чтобы повернуть здание перед установкой." },
        { "The Motel is ready, so you can hire workers.\n\nOpen the Workers panel at the top of the screen. This is where new workers are hired and tracked.", "Мотель готов, теперь можно нанимать рабочих.\n\nОткрой панель Рабочие в верхней части экрана. Здесь нанимаются и отслеживаются новые рабочие." },
        { "Use the Hire New Worker button at the bottom of the Workers panel.\n\nHiring costs money. New workers arrive by bus before they become available.", "Используй кнопку Нанять рабочего внизу панели Рабочие.\n\nНайм стоит денег. Новые рабочие приезжают на автобусе и становятся доступными после прибытия." },
        ...
        { "Need", "Нужно" },
        { "to hire a new truck.", "для покупки нового грузовика." },
        { "to hire a new worker.", "для найма нового рабочего." },
        ...
        { "Hire New Worker", "Нанять рабочего" },
