...
public partial class GameBootstrap
{
    private string GetBuildingQuickStatusText(LocationType locationType)
    {
        ...
        return locationType switch
        {
            ...
            LocationType.Kiosk        => IsRussianLanguage() ? "\u041a\u0438\u043e\u0441\u043a - \u0440\u0430\u0431\u043e\u0447\u0438\u0435 \u043f\u043e\u043a\u0443\u043f\u0430\u044e\u0442 Snack \u0437\u0430 $5." : "Walk-up kiosk - workers buy $5 Snacks.",
            LocationType.CoffeeShop   => IsRussianLanguage() ? "\u041a\u043e\u0444\u0435\u0439\u043d\u044f - \u0440\u0430\u0431\u043e\u0447\u0438\u0435 \u043f\u043e\u043a\u0443\u043f\u0430\u044e\u0442 Coffee \u0437\u0430 $5." : "Walk-up coffee shop - workers buy $5 Coffee.",
    ...
    private string GetBuildingQuickResourceText(LocationType locationType)
    {
        ...
        return locationType switch
        {
            ...
            LocationType.CoffeeShop   => GetServiceBuildingQuickResourceText(locationType),
