...
public partial class GameBootstrap : MonoBehaviour
{
    ...
    private AudioClip uiDeniedClip;
    private AudioClip truckIdleClip;
    private AudioClip truckRollClip;
    private AudioClip truckLoadClip;
    private AudioClip truckUnloadClip;
    ...
    private AudioClip buildPlaceStartClip;
    private AudioClip buildingCompleteClip;
    private AudioClip roadDragClip;
    private AudioClip moneyCollectClip;
    ...
    private static string GetBuildingWorkerRoleLabel(LocationType type) => type switch
    {
        ...
        LocationType.PrimarySchool    => "Teacher",
        LocationType.SecondarySchool  => "Teacher",
