    ...
    private static string GetWorkerKnowledgeBuildingTypeLabel(LocationType buildingType, bool ru)
    {
        if (!ru)
        {
            return buildingType switch
            {
                ...
                LocationType.PrimarySchool => "Primary School",
                LocationType.SecondarySchool => "Secondary School",
        ...
        return buildingType switch
        {
            ...
            LocationType.PrimarySchool => "\u041d\u0430\u0447\u0430\u043b\u044c\u043d\u0430\u044f \u0448\u043a\u043e\u043b\u0430",
            LocationType.SecondarySchool => "\u0421\u0440\u0435\u0434\u043d\u044f\u044f \u0448\u043a\u043e\u043b\u0430",
