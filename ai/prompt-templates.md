...
- If the task touches explicit thought influence rules, `WorkerOpinion` feedback loops, source-thought -> target-thought bias, influence windows/caps, or human-logic links between thoughts, read `ai/Design/worker-thought-influence-matrix.md` before editing.
