...
- explicit influence layer: `GameBootstrap.WorkerThoughtInfluence.cs`; evaluator/data-shape/hook включены, пакеты `Money + Work + Paid Services`, `Needs`, `Family` и `City/Litter` содержат 88 enabled rules;
