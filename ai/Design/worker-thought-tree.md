...
- explicit influence layer: `GameBootstrap.WorkerThoughtInfluence.cs`; evaluator/data-shape/hook включены, пакеты `Money + Work + Paid Services`, `Needs`, `Family`, `Social`, `Transport` и `City/Litter` содержат 100 enabled rules;
